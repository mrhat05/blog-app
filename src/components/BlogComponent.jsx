...
function BlogComponent({ uploaderName, uploadTime, blogTitle, blogContent, blogImage,userID,slug,imageID,isActive}) {
  ...
  return (
    ...
    <div className={`${isDarkMode?"bg-darkBoxColor shadow-[0px_0px_30px_6px_rgba(0,0,0,0.05)] shadow-blue-800  ":"bg-white shadow-lg"}  rounded-lg max-w-3xl mx-auto p-4 sm:p-6 my-4 `}>
        { isOpen && (
