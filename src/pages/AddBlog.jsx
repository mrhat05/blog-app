  ...
  {loader ? (
    ...
    <div className={`${isDarkMode?"bg-darkBgColor":"bg-white"}`}>
      <div className={`max-w-xl mb-52 mx-auto shadow-md rounded-lg my-5 mt-10  `}>
        ...
        <div className={`p-5 rounded-lg ${isDarkMode?"bg-darkBoxColor    shadow-[0px_0px_31px_6px_rgba(0,0,0,0.05)] shadow-blue-800 ":"bg-gray-50 border border-gray-200"} shadow-lg`}>
